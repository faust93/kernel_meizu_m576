...
static BLOCKING_NOTIFIER_HEAD(cluster1_num_max_notifier);
static struct pm_qos_constraints cluster1_num_max_constraints = {
	.list = PLIST_HEAD_INIT(cluster1_num_max_constraints.list),
	.target_value = PM_QOS_CLUSTER1_NUM_MAX_DEFAULT_VALUE,
	.default_value = PM_QOS_CLUSTER1_NUM_MAX_DEFAULT_VALUE,
	.type = PM_QOS_MIN,
	.notifiers = &cluster1_num_max_notifier,
};
static struct pm_qos_object cluster1_num_max_pm_qos = {
	.constraints = &cluster1_num_max_constraints,
	.name = "cluster1_num_max",
};
static BLOCKING_NOTIFIER_HEAD(cluster1_num_min_notifier);
static struct pm_qos_constraints cluster1_num_min_constraints = {
	.list = PLIST_HEAD_INIT(cluster1_num_min_constraints.list),
	.target_value = PM_QOS_CLUSTER1_NUM_MIN_DEFAULT_VALUE,
	.default_value = PM_QOS_CLUSTER1_NUM_MIN_DEFAULT_VALUE,
	.type = PM_QOS_MAX,
	.notifiers = &cluster1_num_min_notifier,
};
static struct pm_qos_object cluster1_num_min_pm_qos = {
	.constraints = &cluster1_num_min_constraints,
	.name = "cluster1_num_min",
};
static BLOCKING_NOTIFIER_HEAD(cluster0_num_max_notifier);
static struct pm_qos_constraints cluster0_num_max_constraints = {
	.list = PLIST_HEAD_INIT(cluster0_num_max_constraints.list),
	.target_value = PM_QOS_CLUSTER0_NUM_MAX_DEFAULT_VALUE,
	.default_value = PM_QOS_CLUSTER0_NUM_MAX_DEFAULT_VALUE,
	.type = PM_QOS_MIN,
	.notifiers = &cluster0_num_max_notifier,
};
static struct pm_qos_object cluster0_num_max_pm_qos = {
	.constraints = &cluster0_num_max_constraints,
	.name = "cluster0_num_max",
};
static BLOCKING_NOTIFIER_HEAD(cluster0_num_min_notifier);
static struct pm_qos_constraints cluster0_num_min_constraints = {
	.list = PLIST_HEAD_INIT(cluster0_num_min_constraints.list),
	.target_value = PM_QOS_CLUSTER0_NUM_MIN_DEFAULT_VALUE,
	.default_value = PM_QOS_CLUSTER0_NUM_MIN_DEFAULT_VALUE,
	.type = PM_QOS_MAX,
	.notifiers = &cluster0_num_min_notifier,
};
static struct pm_qos_object cluster0_num_min_pm_qos = {
	.constraints = &cluster0_num_min_constraints,
	.name = "cluster0_num_min",
};
#endif
...
#ifdef CONFIG_EXYNOS_CPU_CORE_NUM_PM_QOS
	&cluster1_num_max_pm_qos,
	&cluster1_num_min_pm_qos,
	&cluster0_num_max_pm_qos,
	&cluster0_num_min_pm_qos,
#endif
#ifdef CONFIG_EXYNOS_GPU_PM_QOS
       &gpu_freq_min_pm_qos,
       &gpu_freq_max_pm_qos,
